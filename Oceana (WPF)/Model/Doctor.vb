...
Public Class Doctor
    ...
    Public Sub New(doctorID As String, firstName As String, lastName As String, identification As String, contact As String, email As String, address As String)
        _DoctorID = doctorID
...
Public Class ObservableDoctor
    Inherits ObservableCollection(Of Doctor)
End Class
